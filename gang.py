...
try:
    ...
    class MainLoop:
        ...
        def home(self):
            global Flood_Mode
            global in_proxies
            print(Fore.RED+" .d8888b.                                             8888888b.                   888               ")
            print(Fore.BLUE+"d88P  Y88b                                            888  *Y88b                  888               ")
            print(Fore.WHITE+"888    888                                            888    888                  888               ")
            print(Fore.GREEN+"888         8888b.  88888b.   .d88b.  .d8888b         888    888  8888b.  888d888 888  888 .d8888b  ")
            print(Fore.BLUE+"888  88888     *88b 888 *88b d88P*88b 88K             888    888     *88b 888P*   888 .88P 88K      ")
            print(Fore.RED+"888    888 .d888888 888  888 888  888 *Y8888b. 888888 888    888 .d888888 888     888888K  *Y8888b. ")
            print(Fore.YELLOW+"Y88b  d88P 888  888 888  888 Y88b 888      X88        888  .d88P 888  888 888     888 *88b      X88 ")
            print(Fore.BLUE+" Y8888P88  *Y88888  888  888  Y88888  88888P'         8888888P*  *Y888888 888     888  888  88888P     ")
            print(Fore.GREEN+"                                  888                                  Copyright : Pham Chien ")
            print(Fore.RED+"[::] ....::::           Tool DoS By Gangs_Darks           ::::....  [::]")
            print(Fore.RED+"[::] ....::::           Telegram : @gangs_darks_team      ::::....  [::]")
            print(Fore.RED+"[::] ....::::           https://t.me/gangsdarksteam       ::::....  [::]")
            print(Fore.RED+"[::] ....::::           https://github.com/hacmer2008274  ::::....  [::]")
            print ("")
            if os.name in ('nt', 'dos', 'ce'):
                    os.system('title       ........::::: Code By GangS White,HTTP FLOOD Ddos Attack :::::........')
            try:
